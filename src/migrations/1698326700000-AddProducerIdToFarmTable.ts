...
export class AddProducerIdToFarmTable1698326700000 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.addColumn('farm', new TableColumn({
      name: 'producerId',
      type: 'uuid',
    ...
    await queryRunner.createForeignKey('farm', new TableForeignKey({
